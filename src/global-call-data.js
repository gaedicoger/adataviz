...
// const BASE_URL = `https://data.nantesmetropole.fr/api/explore/v2.1/catalog/datasets/244400404_patrimoine-arbore-nantes-metropole/records?where=annee_plantation%20IS%20NOT%20NULL%20and%20lib_genre%20IS%20%20NOT%20NULL&limit=20`;
// const searchAddUrl = `&refine=nom%3A%22${currentSearch}%22`;
...
//   if (currentSearch !== "") {
//     try {
//       currentURL = BASE_URL + searchAddUrl; //URL avec paramètre de recherche sur la commune
...
//   try {
//     if (currentSearch === "") {
//       currentURL = BASE_URL + loadAddUrl;
//     } else {
//       currentURL = BASE_URL + loadAddUrl + searchAddUrl;
//     }
